...
cc.Class({
    ...
    _registerEvent(){
        mEmitter.instance.registerEvent(EventDriver.PROGRESS_BAR.UPDATE_CURRENT_PROGRESS, this._updateCurrentProgress.bind(this), this);
        mEmitter.instance.registerEvent(EventDriver.PROGRESS_BAR.DOWLOADING_PROGRESS, this._dowloading.bind(this), this);
    },
    _onChange(value) {
